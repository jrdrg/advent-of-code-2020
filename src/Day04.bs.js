...
function parsePassport(str) {
  return $$Array.fold_left((function (pp, field) {
                ...
                if (match.length !== 2) {
                  ...
                  switch (match$1) {
                    case "byr" :
                        var value = match[1];
                        return {
                                byr: Caml_format.caml_int_of_string(value),
                                iyr: pp.iyr,
                                eyr: pp.eyr,
                                hgt: pp.hgt,
                                hcl: pp.hcl,
                    ...
                    case "eyr" :
                        ...
                        return {
                                byr: pp.byr,
                                iyr: pp.iyr,
                                eyr: Caml_format.caml_int_of_string(value$3),
                                hgt: pp.hgt,
                                hcl: pp.hcl,
                                ecl: pp.ecl,
                                pid: pp.pid,
                    ...
                    case "iyr" :
                        ...
                        return {
                                byr: pp.byr,
                                iyr: Caml_format.caml_int_of_string(value$6),
                                eyr: pp.eyr,
                                hgt: pp.hgt,
                                hcl: pp.hcl,
                                ecl: pp.ecl,
...
var passports = $$Array.map(parsePassport, $$Array.map((function (param) {
            return param.replace(partial_arg, " ");
          }), inputStr.split("\n\n")));

function day1(param) {
  return List.length(List.filter(isValidPassport)($$Array.to_list(passports)));
}

console.log("Day 1:", day1(/* () */0));

function between(low, high, num) {
  if (num !== undefined) {
    var n = num;
    if (n <= high) {
      return n >= low;
      ...
      if (match$1.length !== 3) {
        ...
        if (match$2 !== undefined) {
          ...
          if (match$3 !== undefined) {
            switch (match$3) {
              case "cm" :
                  return between(150, 193, Caml_format.caml_int_of_string(amt));
              case "in" :
                  return between(59, 76, Caml_format.caml_int_of_string(amt));
              default:
                return false;
            }
          } else {
...
function regexMatch(re, str) {
  return Js_option.getWithDefault(false, Js_option.map((function (s) {
                    return s.search(re) >= 0;
                  }), str));
}

function passportFieldsAreValid(passport) {
  var match = between(1920, 2002, passport.byr);
  var match$1 = between(2010, 2020, passport.iyr);
  var match$2 = between(2020, 2030, passport.eyr);
  var match$3 = isValidHeight(passport.hgt);
  var match$4 = regexMatch((/^#[0-9a-f]{6}$/), passport.hcl);
  var match$5 = regexMatch((/^(amb|blu|brn|gry|grn|hzl|oth)$/), passport.ecl);
  var match$6 = regexMatch((/^(\d{9})$/), passport.pid);
...
function day2(param) {
  return List.length(List.filter(passportFieldsAreValid)(List.filter(isValidPassport)($$Array.to_list(passports))));
}

console.log("Day 2:", day2(/* () */0));

var _inputStr = "ecl:gry pid:860033327 eyr:2020 hcl:#fffffd\nbyr:1937 iyr:2017 cid:147 hgt:183cm\n\niyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884\nhcl:#cfa07d byr:1929\n\nhcl:#ae17e1 iyr:2013\neyr:2024\necl:brn pid:760753108 byr:1931\nhgt:179cm\n\nhcl:#cfa07d eyr:2025 pid:166559648\niyr:2011 ecl:brn hgt:59in";

exports._inputStr = _inputStr;
exports.inputStr = inputStr;
exports.isValidPassport = isValidPassport;
exports.blankPassport = blankPassport;
...
exports.passportFieldsAreValid = passportFieldsAreValid;
exports.day2 = day2;
